...
import { ScienceControl } from "@/components/science/ScienceControl";
...
function App() {
  ...
  const getFirstVisibleApp = (): AppId => {
    ...
    if (visibleApps.science) return "science";
  ...
  const hasSkillsSupport =
    sharedFeatureApp !== "openclaw" && sharedFeatureApp !== "science";
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <ProviderList
                      ...
                      onConfigureUsage={
                        activeApp === "science" ? undefined : setUsageProvider
                      }
            ...
            {currentView !== "providers" ? (
              ...
              <div className="flex items-center gap-2">
                <div className="relative inline-flex items-center">
                  <a
                    href="https://github.com/Vonfre/417switch"
                    target="_blank"
                    rel="noreferrer"
                    className={cn(
              ...
              >
                ...
                {currentView === "providers" && (
                  <>
                    ...
                    {activeApp === "science" && <ScienceControl />}
