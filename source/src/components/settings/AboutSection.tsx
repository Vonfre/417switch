    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/Vonfre/417switch/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/Vonfre/417switch/releases/tag/${displayVersion}`,
      );
    } catch (error) {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="417Switch" className="h-5 w-5" />
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              size="sm"
              onClick={() =>
                settingsApi.openExternal("https://github.com/Vonfre/417switch")
              }
