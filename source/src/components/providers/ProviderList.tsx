...
export function ProviderList({
  ...
  // 故障转移相关
  const failoverAppId = appId === "science" ? "" : appId;
  const { data: isAutoFailoverEnabled } = useAutoFailoverEnabled(failoverAppId);
  const { data: failoverQueue } = useFailoverQueue(failoverAppId);
