...
export function useSettingsForm(): UseSettingsFormResult {
  ...
  useEffect(() => {
    ...
    const normalized: SettingsFormState = {
      ...
      scienceChinesePatchEnabled: data.scienceChinesePatchEnabled ?? true,
      ...
      setSettingsState((prev) => {
        const base =
          ...
          ({
            ...
            scienceChinesePatchEnabled: true,
  ...
  const resetSettings = useCallback(
    (serverData: Settings | null) => {
      ...
      const normalized: SettingsFormState = {
        ...
        scienceChinesePatchEnabled:
          serverData.scienceChinesePatchEnabled ?? true,
