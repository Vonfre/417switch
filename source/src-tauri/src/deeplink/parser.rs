...
//!
//! Parses switch417:// URLs into DeepLinkImportRequest structures.
...
/// Parse a 417Switch URL into a DeepLinkImportRequest.
///
/// Expected format:
/// switch417://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != super::DEEP_LINK_SCHEME && scheme != "ccswitch" {
