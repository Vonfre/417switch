//! Deep link import functionality for 417Switch
//!
//! This module implements the switch417:// protocol for importing configurations
...
pub const DEEP_LINK_SCHEME: &str = "switch417";

pub fn is_deeplink_url(url: &str) -> bool {
    url.starts_with("switch417://") || url.starts_with("ccswitch://")
}
